  ...
  return (
    <div>
      ...
      <section
        ...
        data-aos-once="true"
      >
        <h2>Tabungan Cahaya</h2>
        <p>
          Tabungan merupakan sarana simpanan Dana Pihak Ketiga yang penarikannya
          dapat dilakukan setiap saat. Tabungan Cahaya adalah simpanan pihak
          ketiga yang ditawarkan oleh Bank Cahaya yang memiliki keunikan yaitu
          adanya tingkat suku bunga yang menarik. Selain itu tabungan Cahaya
          ditujukan untuk memenuhi kebutuhan masyarakat akan rekening tabungan
          yang fleksibel untuk transaksi sehari-hari. Lengkap dengan kemudahan
          dalam melakukan transaksi yang dapat dilakukan melalui kantor Bank
          Cahaya atau layanan kas keliling.
        </p>
      </section>
          ...
          <div className="mid-container">
            ...
            <section class="featuress">
              ...
              >
                ...
                <p>
                  Dengan{" "}
                  <span style={{ color: "var(--bluegrotto)" }}>
